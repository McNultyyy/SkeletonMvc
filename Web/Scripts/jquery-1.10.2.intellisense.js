...
intellisense.annotate(_object, {
  ...
  'then': function() {
    /// <signature>
    ///   <summary>Create handlers to be called when the Deferred object is resolved, rejected, or still in progress.</summary>
...
intellisense.annotate(jQuery.fn, {
  ...
  'addBack': function() {
    /// <signature>
    ///   <summary>Create the previous set of elements on the stack to the current set, optionally filtered by a selector.</summary>
